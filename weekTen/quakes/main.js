...
// create the appropriate functions, move the functionality from everythin() to the fucntions so that the showQuakes() function below will work.
...
export default class Quake {
  ...
  async getEarthQuakesByRadius(position, radius = 100) {
    // use the getJSON funtion and the position provided to build out the correct URL to get the data we need. Store it into this._quakes, then return it.
    return this._quakes;
  }
  getQuakeById(id) {
